...
function mapComponents() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const deprecatedComponents = yield registryService.getDeprecatedComponents();
        ...
        for (const deprecated of deprecatedComponents) {
            ...
            const potentialReplacements = yield findPotentialReplacements(deprecated, registryService);
            ...
            yield registryService.addMapping(mapping);
            console.log(`Created mapping with ${bestMatch.name} (Confidence: ${bestMatch.confidence}%)`);
        }
    });
}
function findPotentialReplacements(deprecated, registryService) {
    return __awaiter(this, void 0, void 0, function* () {
        const replacements = [];
        // Get all non-deprecated components
        const allComponents = Object.values((yield registryService.getComponent('')) || {});
...
function generatePropertyMappings(source, target) {
    const mappings = {};
